...
void Book::Use()
{
	...
	way has been found. My last hope hangs on the words of
	an old rambling man. "East of the lamp, a keen eye finds
	what he is searching for". There must be something I'm
	missing...
	)" << endl;
	system("pause");
}
